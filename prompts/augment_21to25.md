# Claude Code Prompt: First 5 Legal Answer Augmentation Pilot

```text
I want to run a small legal data augmentation pilot using the first 5 Markdown files in:
...
1. Select the first 5 `.md` files from the directory, sorted by filename.
...
data/augmentation/source_answers_first5.jsonl
