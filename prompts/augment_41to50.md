# Cursor Prompt: 41st to 50th Legal Answer Augmentation Pilot

```text
I want to run a small legal data augmentation pilot using the 41st to 50th Markdown files in:
...
1. Select the 41st to 50th `.md` files from the directory, sorted by filename.
